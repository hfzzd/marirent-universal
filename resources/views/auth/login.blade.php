            ...
            <div class="glass-card rounded-3xl p-8 shadow-xl shadow-sky-500/5">
                ...
                <div class="mt-5 pt-5 border-t border-gray-100">
                    ...
                    <div class="grid grid-cols-2 gap-2" x-data>
                        @php $demos = [['Admin','admin@marirent.com'],['Owner','owner@marirent.com'],['User','user@marirent.com'],['Driver','driver@marirent.com'],['Inspector','inspector@marirent.com']]; @endphp
                        @foreach($demos as $d)
...
<script>
    ...
    // Loading state on submit (cegah double-submit yang memicu 419)
    (function () {
        let submitted = false;
