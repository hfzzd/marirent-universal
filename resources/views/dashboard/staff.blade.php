...
@section('page-title', 'Beranda Staff')
    ...
    <div class="relative px-6 py-7 md:px-8 md:py-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
        <div>
            ...
            <p class="text-sky-100/80 text-xs md:text-sm mt-1 max-w-lg">
                Posisi: <span class="font-bold text-white">{{ $driver->position ?? 'Staff Operasional' }}</span> &bull;
                No. HP: <span class="font-bold text-white">{{ auth()->user()->phone ?? '-' }}</span>
            </p>
        </div>
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
    ...
    <div class="stat-card glass-card rounded-2xl p-5 border border-sky-100/50 shadow-sm">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-[11px] font-bold uppercase tracking-wider text-gray-400">Performa Staff</p>
...
<div class="glass-card rounded-2xl p-12 text-center max-w-lg mx-auto my-8">
    ...
    <h3 class="text-lg font-bold text-navy-800 mb-1">Profil Staff Belum Terdaftar</h3>
    <p class="text-xs text-gray-400">Akun Anda belum ditautkan ke data personel (Driver/Staff) sistem. Silakan hubungi Administrator untuk aktivasi.</p>
</div>
@endif
@endsection