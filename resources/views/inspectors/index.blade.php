...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-5 gap-3">
    <div class="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
        <form action="{{ route('inspectors.index') }}" method="GET" class="flex gap-2 flex-wrap">
            ...
            <a href="{{ route('inspectors.index') }}" class="bg-red-50 hover:bg-red-100 text-red-500 px-3 py-2 rounded-lg text-[13px] transition border border-red-100"><i class="fas fa-times"></i></a>
            @endif
        </form>
    </div>
