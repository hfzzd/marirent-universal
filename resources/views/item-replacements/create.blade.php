    ...
    <form method="POST" action="{{ route('item-replacements.store') }}" enctype="multipart/form-data" x-data="{ loading: false }" @submit="loading = true">
        ...
        <div class="glass-card rounded-2xl p-6 mb-5 border border-sky-100/50">
            ...
            <div class="grid grid-cols-3 gap-2">
                @foreach(['hp' => ['HP', 'fa-mobile-alt text-blue-500', 'text-blue-500'], 'camera' => ['Kamera', 'fa-camera text-violet-500', 'text-violet-500'], 'tenda' => ['Tenda', 'fa-campground text-emerald-500', 'text-emerald-500']] as $val => [$label, $icon, $iconColor])
