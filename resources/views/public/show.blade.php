...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <div class="mb-6">
        <a href="{{ route('home') }}" class="text-sky-600 hover:text-sky-700 text-sm"><i class="fas fa-arrow-left mr-1"></i> Kembali</a>
    </div>
    ...
    <div class="mt-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="vehicle-card bg-white rounded-2xl shadow-sm overflow-hidden border border-gray-100">
                <div class="h-40 bg-gradient-to-br from-sky-50 to-sky-100 flex items-center justify-center">
