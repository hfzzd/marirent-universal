    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            <thead><tr class="bg-sky-50/50 border-b border-sky-100/50">
                ...
                <th class="text-left py-3 px-4 text-navy-500 font-medium">Alasan</th>
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-sky-50/30">
                    ...
                    <td class="py-3 px-4 text-navy-500 max-w-[200px] truncate">{{ $r->reason ?? '-' }}</td>
                ...
                @empty
                <tr><td colspan="7" class="py-8 text-center text-navy-400">Belum ada permintaan penggantian kendaraan</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
