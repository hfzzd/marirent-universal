    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div class="space-y-3 text-sm">
                <div class="flex justify-between"><span class="text-navy-500">Booking</span><span class="font-medium text-primary-600">{{ $tripReport->booking->booking_code ?? '-' }}</span></div>
                ...
                <div class="flex justify-between"><span class="text-navy-500">Total Jarak</span><span class="font-bold text-primary-600">{{ $tripReport->total_distance ? number_format($tripReport->total_distance, 1) . ' km' : '-' }}</span></div>
            </div>
        </div>
        <div class="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div class="space-y-3 text-sm">
                ...
                <div class="border-t pt-3 flex justify-between"><span class="font-bold text-navy-800">Total Operasional</span><span class="font-bold text-primary-600">Rp {{ number_format($tripReport->total_operational_cost,0,',','.') }}</span></div>
            </div>
            @if($tripReport->notes)
